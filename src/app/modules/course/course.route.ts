...
router.put("/:courseId/assign-faculties", CourseControllers.assignCourseFaculties)

router.delete("/:courseId/remove-faculties", CourseControllers.deleteCourseFaculties)
